...
engine = create_async_engine(
    mysql_config.async_database_url,
...
ORM operations against the MySQL database.
"""

AsyncSessionLocal = async_sessionmaker(
    autocommit=mysql_config.autocommit,
    autoflush=mysql_config.autoflush,
    bind=engine,
    class_=AsyncSession,
    expire_on_commit=mysql_config.expire_on_commit
)
"""
...
are dictated by the `MySQLConfig` settings.
"""
